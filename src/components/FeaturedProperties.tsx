...
const properties: Property[] = [
  { id: 'prop-1', title: 'One Northline Plaza', location: 'Midtown Manhattan, New York', image: 'https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?q=80&w=2070&auto=format&fit=crop', specs: '350,000 SQ. FT. • CLASS-A OFFICE', category: 'Local commercial', price: 120, priceLabel: '$120 / Sq. Ft. / Yr', status: 'available' },
  { id: 'prop-2', title: 'The Atrium at Westside', location: 'Silicon Valley, California', image: 'https://images.unsplash.com/photo-1497366216548-37526070297c?q=80&w=2069&auto=format&fit=crop', specs: '180,000 SQ. FT. • TECH HQ / R&D', category: 'Local commercial', price: 95, priceLabel: '$95 / Sq. Ft. / Yr', status: 'reserved', reservedUntil: new Date(Date.now() + 1000 * 60 * 60 * 17).toISOString() },
  { id: 'prop-3', title: 'Summit Logistics Hub', location: 'Port of Newark, New Jersey', image: 'https://images.unsplash.com/photo-1587293852726-70cdb56c2866?q=80&w=2072&auto=format&fit=crop', specs: '500,000 SQ. FT. • FREESTANDING LOGISTICS', category: 'Terrain', price: 22, priceLabel: '$22 / Sq. Ft. / Yr', status: 'sold' },
];
