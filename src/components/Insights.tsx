...
export default function Insights({ onContactClick }: InsightsProps) {
  ...
  const articles = [
    {
      id: 'ins-1',
      title: t('insights', 'a1Title'),
      date: t('insights', 'a1Date'),
      category: t('insights', 'market'),
      image: 'https://images.unsplash.com/photo-1560518883-ce09059eeffa?q=80&w=2070&auto=format&fit=crop',
      excerpt: t('insights', 'a1Excerpt'),
    },
    {
      id: 'ins-2',
      title: t('insights', 'a2Title'),
      date: t('insights', 'a2Date'),
      category: t('insights', 'sustainability'),
      image: 'https://images.unsplash.com/photo-1497366754035-f200968a6e72?q=80&w=2069&auto=format&fit=crop',
      excerpt: t('insights', 'a2Excerpt'),
    },
    {
      id: 'ins-3',
      title: t('insights', 'a3Title'),
      date: t('insights', 'a3Date'),
      category: t('insights', 'logistics'),
      image: 'https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?q=80&w=2070&auto=format&fit=crop',
      excerpt: t('insights', 'a3Excerpt'),
    },
  ];
